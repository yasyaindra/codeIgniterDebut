                        ...
                        <tbody>
                            ...
                            <?php foreach ($role as $r) : ?>
                                <tr>
                                    ...
                                    <td><?= $r['role']; ?></td>
                                    <td>
                                        <a href="<?= base_url('index.php/admin/roleaccess/') . $r['id'] ?>" class="badge badge-pill badge-success">Access</a>
            ...
            <div class="modal-dialog modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="newRoleModalTitle">Add Role Data</h5>
